                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Builder(
                        builder: (context) {
                          final lvFaq = FFAppState().faq.toList();
                          return ListView.builder(
                            padding: EdgeInsets.zero,
                            primary: false,
                            shrinkWrap: true,
                            scrollDirection: Axis.vertical,
                            itemCount: lvFaq.length,
                            itemBuilder: (context, lvFaqIndex) {
                              final lvFaqItem = lvFaq[lvFaqIndex];
                              return Padding(
                          ...
                          children: [
                            Padding(
                              padding: EdgeInsetsDirectional.fromSTEB(
                                  0.0, 0.0, 0.0, 2.0),
                              child: Image.asset(
                                'assets/images/icon__question_on.png',
                                width: 24.0,
                                fit: BoxFit.contain,
                              ),
                            ),
